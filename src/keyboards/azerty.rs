...
impl KeyMap for Azerty {
    fn format(&self, key: &Code, is_shifted: bool) -> String {
        let key_as_str = match key {
            ...
            Code::KEY_SCREENLOCK => "<screen_lock>",
            ...
            Code::KEY_BACK => "<back>",
            Code::KEY_FORWARD => "<forward>",
            Code::KEY_CLOSECD => todo!(),
            Code::KEY_EJECTCD => todo!(),
            Code::KEY_EJECTCLOSECD => todo!(),
            Code::KEY_NEXTSONG => "<next_song>",
            Code::KEY_PLAYPAUSE => "<play/pause>",
            Code::KEY_PREVIOUSSONG => "<previous_song>",
            ...
            Code::KEY_MOVE => todo!(),
            Code::KEY_EDIT => todo!(),
            Code::KEY_SCROLLUP => "<scroll_up>",
            Code::KEY_SCROLLDOWN => "<scroll_down>",
